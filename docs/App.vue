<template>
  ...
  <tabs ref="testTabs">
    ...
    <tab
      nav-item-class="tabs-component-tab--custom"
      nav-item-link-class="tabs-component-tab-a--custom"
      name="Custom navigation item classes"
    >
      <h2 class="page-subtitle">
        Custom navigation item classes
      </h2>
  ...
  <section class="page-about">
    ...
    <p>
      The component will use the <strong>fragment</strong> of the url to choose which tab to open. So clicking
      <a href="#second-tab">#second-tab</a>
      will display the contents of the tab named <code>Second tab</code>.</p>

    <p>
      The component will also <strong>remember</strong>
    ...
    <p>
      ...
      <button
        class="tabs-component-btn"
        @click="changeToARandomTab"
      >
